...
TASK_FILE = Path("[PLACEHOLDER_TASK_FILE_PATH]")
...
with tab6:
    ...
    with st.expander("🛠️ Repository Binding", expanded=True):
        st.text_input("Constitution Repo URL", value="https://github.com/[GITHUB_USERNAME]/omega-constitution.git")
        st.text_input("Store Repo URL", value="https://github.com/[GITHUB_USERNAME]/omega-store.git")
        st.text_input("Personal Projects Path", value="[LOCAL_PROJECTS_PATH]")
